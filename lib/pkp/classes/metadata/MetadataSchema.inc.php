 ...
 *  can be mapped to SEP application objects. Meta-data schemas are not meant to
 *  represent any meta-data in the given schema just SEP application meta-data. The
 ...
 *  SEPAuthor class. We do not implement composites for title meta-data
...
import('lib.sep.classes.metadata.MetadataProperty');
...
class MetadataSchema {
	 ...
	 *  SEP application objects that can be described using
	...
	/**
	 * Get the association types for SEP application objects
