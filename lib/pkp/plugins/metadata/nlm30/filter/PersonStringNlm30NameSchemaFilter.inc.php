...
class PersonStringNlm30NameSchemaFilter extends Nlm30PersonStringFilter {
	...
	function PersonStringNlm30NameSchemaFilter($assocType, $filterMode = PERSON_STRING_FILTER_SINGLE, $filterTitle = false, $filterDegrees = false) {
		...
		$outputType = 'metadata::lib.sep.plugins.metadata.nlm30.schema.Nlm30NameSchema(*)';
	...
	function &_parsePersonString($personString, $title, $degrees) {
		...
		$personDescription = new MetadataDescription('lib.sep.plugins.metadata.nlm30.schema.Nlm30NameSchema', $this->_assocType);
