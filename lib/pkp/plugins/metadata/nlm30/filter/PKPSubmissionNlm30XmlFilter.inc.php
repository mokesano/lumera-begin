...
/**
 * @file plugins/metadata/nlm30/filter/SEPSubmissionNlm30XmlFilter.inc.php
 *
 * Copyright (c) 2013-2017 Simon Fraser University
 * Copyright (c) 2000-2016 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class SEPSubmissionNlm30XmlFilter
...
class SEPSubmissionNlm30XmlFilter extends TemplateBasedReferencesListFilter {
	/**
	 * Constructor
	 * @param $filterGroup FilterGroup
	 */
	function SEPSubmissionNlm30XmlFilter(&$filterGroup) {
		...
		$this->setData('citationOutputFilterName', 'lib.sep.plugins.metadata.nlm30.filter.Nlm30CitationSchemaNlm30XmlFilter');
		// Set the metadata schema.
		$this->setData('metadataSchemaName', 'lib.sep.plugins.metadata.nlm30.schema.Nlm30CitationSchema');
	}
	...
	function getClassName() {
		return 'lib.sep.plugins.metadata.nlm30.filter.SEPSubmissionNlm30XmlFilter';
	}
