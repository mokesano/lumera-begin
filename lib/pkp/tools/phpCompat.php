 ...
 *            Arguments: ${project_loc}/lib/sep/tools/phpCompat.php "${resource_loc}"
 *
 *          Common tab:
...
// FIXME: This doesn't work if lib/sep is symlinked. realpath($_['SCRIPT_FILENAME'].'/../../index.php') could work but see http://bugs.php.net/bug.php?id=50366
