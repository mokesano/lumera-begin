...
{if $isInstallError}
<p>
	<span class="sep_form_error">{translate key="installer.installErrorsOccurred"}:</span>
		...
		<td class="value">
			{foreach from=$localeOptions key=localeKey item=localeName}
				...
				{if !$localesComplete[$localeKey]}
					<span class="sep_form_error">*</span>
			...
			{if $incompleteLocaleFound}
				<br />
				<span class="sep_form_error">*</span>&nbsp;{translate key="installer.locale.maybeIncomplete"}
			{/if}{* $incompleteLocaleFound *}
		</td>
	</tr>
	<tr valign="top">
