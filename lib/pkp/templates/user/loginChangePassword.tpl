...
<script type="text/javascript">
	$(function() {ldelim}
		...
		$('#loginChangePassword').sepHandler('$.sep.controllers.form.FormHandler');
	{rdelim});
</script>
...
<form class="sep_form" id="loginChangePassword" method="post" action="{url page="login" op="savePassword"}">
{if $confirmHash}
