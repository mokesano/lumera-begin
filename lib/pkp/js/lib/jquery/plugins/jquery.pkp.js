...
/**
 * @file js/lib/jquery/plugins/jquery.sep.js
 *
...
(function($) {
	 ...
	 */
	$.fn.sepHandler = function(handlerName, options) {
		...
		this.each(function() {
			...
			// to the element.
			options = options || {};
			var handler = $.sep.classes.Helper.objectFactory(
	 ...
	 * @return {jQuery} Selected HTML elements for chaining.
	 */
	$.fn.sepAjaxHtml = function(url, callback) {
