...
(function($) {
	 ...
	 */
	$.sep.controllers.UrlInDivHandler = function($divElement, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.UrlInDivHandler, $.sep.classes.Handler);
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.UrlInDivHandler.sourceUrl_ = null;
	 ...
	 */
	$.sep.controllers.UrlInDivHandler.prototype.reload = function() {
		$.get(this.sourceUrl_,
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.UrlInDivHandler.prototype.handleLoadedContent_ =
