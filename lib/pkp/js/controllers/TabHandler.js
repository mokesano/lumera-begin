...
(function($) {
	 ...
	 */
	$.sep.controllers.TabHandler = function($tabs, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.TabHandler, $.sep.classes.Handler);
	 ...
	 * @type {jQuery}
	 */
	$.sep.controllers.TabHandler.prototype.$currentTab_ = null;
	 ...
	 * @type {number}
	 */
	$.sep.controllers.TabHandler.prototype.currentTabIndex_ = 0;
	 ...
	 * @type {boolean}
	 */
	$.sep.controllers.TabHandler.prototype.emptyLastTab_ = false;
	 ...
	 */
	$.sep.controllers.TabHandler.prototype.tabsSelect =
			function(tabsElement, event, ui) {

		var unsavedForm = false;
		this.$currentTab_.find('form').each(function(index) {

			var handler = $.sep.classes.Handler.getHandler($('#' + $(this).attr('id')));
	 ...
	 * @return {boolean} Should return true to continue tab loading.
	 */
	$.sep.controllers.TabHandler.prototype.tabsShow =
			function(tabsElement, event, ui) {
	 ...
	 * @return {boolean} Should return true to continue tab loading.
	 */
	$.sep.controllers.TabHandler.prototype.tabsLoad =
			function(tabsElement, event, ui) {
		return true;
	};
	 ...
	 */
	$.sep.controllers.TabHandler.prototype.dataFilter =
	 ...
	 */
	$.sep.controllers.TabHandler.prototype.tabsReloadRequested =
	 ...
	 */
	$.sep.controllers.TabHandler.prototype.getCurrentTab = function() {
	 ...
	 */
	$.sep.controllers.TabHandler.prototype.getCurrentTabIndex = function() {
