 ...
 *
 * @brief SEP autocomplete handler (extends the functionality of the
...
(function($) {
	 ...
	 */
	$.sep.controllers.AutocompleteHandler = function($autocompleteField, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.AutocompleteHandler, $.sep.classes.Handler);
	 ...
	 * @const
	 */
	$.sep.controllers.AutocompleteHandler.DEFAULT_PROPERTIES_ = {
		// General settings
		minLength: 2
	};
	 ...
	 * @type {jQueryObject}
	 */
	$.sep.controllers.AutocompleteHandler.prototype.hiddenInput_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.AutocompleteHandler.prototype.sourceUrl_ = null;
	 ...
	 * @type {jQueryObject}
	 */
	$.sep.controllers.AutocompleteHandler.prototype.textInput = null;
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.AutocompleteHandler.prototype.itemSelected =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.AutocompleteHandler.prototype.itemFocused =
			function(autocompleteElement, event, ui) {
		var $textInput;
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.AutocompleteHandler.prototype.fetchAutocomplete =
	 ...
	 */
	$.sep.controllers.AutocompleteHandler.prototype.getAutocompleteUrl =
			function() {
	 ...
	 */
	$.sep.controllers.AutocompleteHandler.prototype.setAutocompleteUrl =
			function(url) {
		this.sourceUrl_ = url;
	};
	 ...
	 * @private
	 */
	$.sep.controllers.AutocompleteHandler.prototype.synchronizeFields_ =
			function() {
	 ...
	 * @private
	 */
	$.sep.controllers.AutocompleteHandler.prototype.textInputBlurHandler_ =
			function() {
