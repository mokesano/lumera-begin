...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.modal.AjaxModalHandler
	 *
	 * @inheritDoc
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler =
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.modal.AjaxLegacyPluginModalHandler,
			$.sep.controllers.modal.AjaxModalHandler);
	 ...
	 * @type {string}
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.url_ = null;
	...
	//
	/** @inheritDoc */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.dialogOpen =
		...
		$dialogElement.sepAjaxHtml(url, callback);
	};
	 ...
	 *  modal?
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.refreshModal_ =
	 ...
	 * @private
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.
		...
		if ($newTitle.length > 0) {
			var $currentTitle = $dialogElement.parent()
					.find('.sep_controllers_modal_titleBar h2');
		...
		var $formElements = $('form.sep_form', $dialogElement);
	 ...
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.bindClickEvent_ =
	 ...
	 */
	$.sep.controllers.modal.AjaxLegacyPluginModalHandler.prototype.handleResponse_ =
