...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.modal.ModalHandler
	 *
	 ...
	 */
	$.sep.controllers.modal.AjaxModalHandler = function($handledElement, options) {
	...
	$.sep.classes.Helper.inherits($.sep.controllers.modal.AjaxModalHandler,
			$.sep.controllers.modal.ModalHandler);
	...
	//
	/** @inheritDoc */
	$.sep.controllers.modal.AjaxModalHandler.prototype.checkOptions =
			function(options) {
	...
	/** @inheritDoc */
	$.sep.controllers.modal.AjaxModalHandler.prototype.mergeOptions =
			function(options) {
		// Bind open event.
	...
	/** @inheritDoc */
	$.sep.controllers.modal.AjaxModalHandler.prototype.modalClose =
	 ...
	 */
	$.sep.controllers.modal.AjaxModalHandler.prototype.dialogOpen =
