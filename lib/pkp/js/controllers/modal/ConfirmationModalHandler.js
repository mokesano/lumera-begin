...
(function($) {
	...
	$.sep.classes.Helper.inherits($.sep.controllers.modal.ConfirmationModalHandler,
	...
	//
	/** @inheritDoc */
	$.sep.controllers.modal.ConfirmationModalHandler.prototype.checkOptions =
			function(options) {
	...
	/** @inheritDoc */
	$.sep.controllers.modal.ConfirmationModalHandler.prototype.mergeOptions =
			function(options) {
	 ...
	 */
	$.sep.controllers.modal.ConfirmationModalHandler.prototype.modalConfirm =
