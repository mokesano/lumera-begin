...
jQuery.sep.controllers.modal = jQuery.sep.controllers.modal || { };
...
(function($) {
	 ...
	 */
	$.sep.controllers.modal.ModalHandler = function($handledElement, options) {
	...
	$.sep.classes.Helper.inherits($.sep.controllers.modal.ModalHandler,
			$.sep.classes.Handler);
	 ...
	 * @const
	 */
	$.sep.controllers.modal.ModalHandler.DEFAULT_OPTIONS_ = {
		autoOpen: true,
		width: 710,
		modal: true,
		draggable: false,
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.checkOptions =
			function(options) {
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.mergeOptions =
			function(options) {
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.modalClose =
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.dialogClose =
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.outsideClick =
			function(callingContext, event) {
	 ...
	 */
	$.sep.controllers.modal.ModalHandler.prototype.fixTitleBar_ =
			function($handledElement, options) {

		// The new titlebar.
		var $titleBar = $('<div class="sep_controllers_modal_titleBar"></div>');
	 ...
	 * @param {Object} options The dialog options.
	 */
	$.sep.controllers.modal.ModalHandler.prototype.fixCloseButton_ =
			function($handledElement, options) {
	 ...
	 * @private
	 */
	$.sep.controllers.modal.ModalHandler.prototype.redirectNotifyUserEventHandler_ =
			function(sourceElement, event, triggerElement) {

		// Use the notification helper to redirect the notify user event.
		$.sep.classes.notification.NotificationHelper.
