...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.grid.GridHandler
	 *
	 * @param {jQuery} $grid The grid this handler is
	 *  attached to.
	 * @param {Object} options Grid handler configuration.
	 */
	$.sep.controllers.grid.CategoryGridHandler = function($grid, options) {
		this.parent($grid, options);
	};
	$.sep.classes.Helper.inherits($.sep.controllers.grid.CategoryGridHandler,
			$.sep.controllers.grid.GridHandler);
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategoryIdPrefix =
			function() {
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategories =
			function() {
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategoryByDataId =
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategoryRow =
	 ...
	 * @return {jQuery} Category rows.
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getRowsInCategory =
			function($category) {
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategoryDataId =
			function($category) {
	 ...
	 * @return {string} Category data id.
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getCategoryDataIdByRowId =
			function(gridRowId) {
	 ...
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.appendCategory =
			function($category) {
	 ...
	 * element id as value.
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.resequenceCategories =
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.initialize =
			function(options) {
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getElementsByType =
			function($element) {
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.getEmptyElement =
			function($element) {
		if ($element.hasClass('category_grid_body')) {
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.refreshGridHandler =
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.deleteElement =
			function($element) {
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.appendElement =
			function($element) {
		var $gridBody = null;
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.replaceElement =
	 ...
	 * @inheritDoc
	 */
	$.sep.controllers.grid.CategoryGridHandler.prototype.hasSameNumOfColumns =
			function($row) {
		var $element = $row;
