...
(function($) {
	...
	$.sep.controllers.grid = $.sep.controllers.grid || {};
	 ...
	 */
	$.sep.controllers.grid.GridHandler = function($grid, options) {
	...
	$.sep.classes.Helper.inherits($.sep.controllers.grid.GridHandler,
			$.sep.classes.Handler);
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.grid.GridHandler.prototype.gridId_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.grid.GridHandler.prototype.fetchRowUrl_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.grid.GridHandler.prototype.fetchGridUrl_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.grid.GridHandler.prototype.bodySelector_ = null;
	 ...
	 * @type {Object}
	 */
	$.sep.controllers.grid.GridHandler.prototype.features_ = null;
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getFetchRowUrl =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getRows =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getGridIdPrefix =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getRowIdPrefix =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getRowDataId =
			function($gridRow) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getParentRow =
			function($element) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getElementsByType =
			function($element) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getEmptyElement =
			function($element) {
		if ($element.hasClass('gridRow')) {
	 ...
	 *  issued the event.
	 */
	$.sep.controllers.grid.GridHandler.prototype.toggleRowActions =
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.hideAllVisibleRowActions =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.hideRowActionsDiv =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.showRowActionsDiv =
			function() {
		var $rowActionDivs, index, limit, $div;
		...
		// See $.sep.controllers.grid.GridHandler.prototype.hideRowActionsDiv
		for (index = 0, limit = $rowActionDivs.length; index < limit; index++) {
			$div = $($rowActionDivs[index]);
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.changeLinkActionsState =
			function(enable, $linkElements) {
		if ($linkElements === undefined) {
			$linkElements = $('.sep_controllers_linkAction', this.getHtmlElement());
		}
		$linkElements.each(function() {
			/** {$.sep.controllers.LinkActionHandler} */
			var linkHandler;
			linkHandler = $.sep.classes.Handler.getHandler($(this));
			if (enable) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.resequenceRows =
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.updateControlRowsPosition =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.initialize =
			function(options) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.callFeaturesHook =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.grid.GridHandler.prototype.refreshGridHandler =
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.deleteElement =
			function($element) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.appendElement =
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.replaceElement =
	 ...
	 * or not.
	 */
	$.sep.controllers.grid.GridHandler.prototype.hasSameNumOfColumns =
	 ...
	 * @private
	 *
	 * @param {$.sep.controllers.form.ClientFormHandler} filterForm
	 *  The filter form.
	 * @param {Event} event A "formSubmitted" event.
	 * @param {string} filterData Serialized filter data.
	 */
	/*jslint unparam: true*/
	$.sep.controllers.grid.GridHandler.prototype.refreshGridWithFilterHandler_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.grid.GridHandler.prototype.addRowHandler_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.grid.GridHandler.prototype.replaceElementResponseHandler_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.grid.GridHandler.prototype.replaceGridResponseHandler_ =
			function(ajaxContext, jsonData) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.insertOrReplaceElement_ =
	 ...
	 *  deleted.
	 */
	$.sep.controllers.grid.GridHandler.prototype.deleteControlsRow_ =
			function($row) {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.getControlRowByGridRow =
			function($gridRow) {
	 ...
	 * @private
	 */
	$.sep.controllers.grid.GridHandler.prototype.activateRowActions_ =
			function() {
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.applyToggleRowActionEffect_ =
			function($controlRow) {
		var delay, $row;
	 ...
	 * @param {$.sep.classes.features.Feature} $feature The grid
	 * feature to be added.
	 */
	$.sep.controllers.grid.GridHandler.prototype.addFeature_ =
			function(id, $feature) {
		if (!this.features_) {
			this.features_ = [];
		}
	 ...
	 */
	$.sep.controllers.grid.GridHandler.prototype.initFeatures_ =
			function(features) {

		var id, $feature;
		for (id in features) {
			$feature =
					/** @type {$.sep.classes.features.Feature} */
					($.sep.classes.Helper.objectFactory(
							features[id].JSClass,
