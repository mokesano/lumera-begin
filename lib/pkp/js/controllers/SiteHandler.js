...
(function($) {
	 ...
	 */
	$.sep.controllers.SiteHandler = function($widgetWrapper, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.SiteHandler, $.sep.classes.Handler);
	 ...
	 * @type {Object}
	 */
	$.sep.controllers.SiteHandler.prototype.options_ = null;
	 ...
	 * @type {Array}
	 */
	$.sep.controllers.SiteHandler.prototype.unsavedFormElements_ = null;
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.redirectToUrl =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.registerUnsavedFormElement_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.unregisterUnsavedFormElement_ =
			function(siteHandlerElement, sourceElement, event) {
		var $formElement, formId, index;
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.unregisterAllFormElements_ =
			function() {
		this.unsavedFormElements_ = [];
	};
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.toggleInlineHelpHandler_ =
			function() {
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.updateHelpDisplayHandler_ =
			function() {
		...
		if (inlineHelpState) {
			...
			$bodyElement.find('.sep_grid_description, #legend, .sep_help').
					css('visibility', 'visible').show();
			$bodyElement.find('[id^="toggleHelp"]').html(
					this.options_.toggleHelpOffText);
		} else {
			$bodyElement.find('.sep_grid_description, #legend, .sep_help').hide();
			$bodyElement.find('[id^="toggleHelp"]').html(
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.fetchNotificationHandler_ =
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.updateHeaderHandler_ =
			function() {
		var handler = $.sep.classes.Handler.getHandler($('#headerContainer'));
		handler.reload();
	};
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.updateSidebarHandler_ =
			function() {
		var handler = $.sep.classes.Handler.getHandler($('#sidebarContainer'));
		handler.reload();
	};
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.callWhenClickOutsideHandler_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.checkOutsideClickHandler_ =
	 ...
	 */
	$.sep.controllers.SiteHandler.prototype.pageUnloadHandler_ =
			function() {
		...
		handler = $.sep.classes.Handler.getHandler($('body'));
		...
		if (unsavedElementCount > 0) {
			return $.sep.locale.form_dataHasChanged;
		}
		return null;
	};
	 ...
	 */
	$.sep.controllers.SiteHandler.prototype.isFormUnsaved =
			function(id) {
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.SiteHandler.prototype.showNotificationResponseHandler_ =
	 ...
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.showNotification_ =
			function(jsonData) {
	...
	/**
	 * Set the maximum width for the sep_structure_main div.
	 * This will prevent content with larger widths (like photos)
	 * messing up with layout.
	 * @private
	 */
	$.sep.controllers.SiteHandler.prototype.setMainMaxWidth_ =
			function() {
		...
		structureContentWidth = $('.sep_structure_content', $site).width();

		leftSideBarWidth = $('.sep_structure_sidebar_left', $site).
				outerWidth(true);
		rightSideBarWidth = $('.sep_structure_sidebar_right', $site).
				outerWidth(true);

		$mainDiv = $('.sep_structure_main', $site);
