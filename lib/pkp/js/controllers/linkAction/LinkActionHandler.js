...
jQuery.sep.controllers.linkAction = jQuery.sep.controllers.linkAction || { };
...
(function($) {
	...
	$.sep.controllers.linkAction.LinkActionHandler =
		...
		this.linkActionRequest_ =
				/** @type {$.sep.classes.linkAction.LinkActionRequest} */
	 ...
	 * @type {$.sep.classes.linkAction.LinkActionRequest}
	 */
	$.sep.controllers.linkAction.LinkActionHandler.prototype.
	...
	$.sep.controllers.linkAction.LinkActionHandler.prototype.
		...
		if (this.linkActionRequest_.getObjectName() !=
				'$.sep.classes.linkAction.NullAction') {
			this.disableLink();
		}
	...
	$.sep.controllers.linkAction.LinkActionHandler.prototype.
		...
		if (this.getHtmlElement().parents('.sep_controllers_grid').length === 0) {
