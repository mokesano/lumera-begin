...
(function($) {
	 ...
	 */
	$.sep.controllers.ExtrasOnDemandHandler = function($widgetWrapper, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.ExtrasOnDemandHandler, $.sep.classes.Handler);
	 ...
	 */
	$.sep.controllers.ExtrasOnDemandHandler.prototype.toggleExtras =
	 ...
	 */
	$.sep.controllers.ExtrasOnDemandHandler.prototype.activateExtraContent_ =
	 ...
	 * @param {string=} opt_duration The effect duration.
	 */
	$.sep.controllers.ExtrasOnDemandHandler.prototype.deactivateExtraContent_ =
			function(opt_duration) {
	 ...
	 */
	$.sep.controllers.ExtrasOnDemandHandler.prototype.scrollToMakeVisible_ =
