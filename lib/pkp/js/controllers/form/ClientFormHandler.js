...
(function($) {
	 ...
	 */
	$.sep.controllers.form.ClientFormHandler = function($form, options) {
		options.submitHandler = this.submitForm;
		this.parent($form, options);
	};
	$.sep.classes.Helper.inherits(
			$.sep.controllers.form.ClientFormHandler,
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.ClientFormHandler.prototype.submitForm =
