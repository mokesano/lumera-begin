...
(function($) {
	 ...
	 */
	$.sep.controllers.form.FormHandler = function($form, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.form.FormHandler,
			$.sep.classes.Handler);
	 ...
	 * @type {Function}
	 */
	$.sep.controllers.form.FormHandler.prototype.callerSubmitHandler_ = null;
	 ...
	 * @type {String}
	 */
	$.sep.controllers.form.FormHandler.prototype.cancelRedirectUrl_ = null;
	 ...
	 * @type {boolean}
	 */
	$.sep.controllers.form.FormHandler.prototype.trackFormChanges_ = true;
	 ...
	 * @type {boolean}
	 */
	$.sep.controllers.form.FormHandler.prototype.formChangesTracked = false;
	 ...
	 * @type {boolean}
	 */
	$.sep.controllers.form.FormHandler.prototype.disableControlsOnSubmit = false;
	 ...
	 * @type {Object}
	 */
	$.sep.controllers.form.FormHandler.prototype.enableDisablePairs_ = null;
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.FormHandler.prototype.showErrors =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.FormHandler.prototype.formChange =
	 ...
	 * @protected
	 */
	$.sep.controllers.form.FormHandler.prototype.disableFormControls =
			function() {
	 ...
	 * @protected
	 */
	$.sep.controllers.form.FormHandler.prototype.enableFormControls =
			function() {
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.FormHandler.prototype.cancelForm =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.FormHandler.prototype.resetForm =
	 ...
	 * @param {Object} validator The validator plug-in.
	 */
	$.sep.controllers.form.FormHandler.prototype.submitFormWithoutValidation =
			function(validator) {
	 ...
	 * @private
	 */
	$.sep.controllers.form.FormHandler.prototype.initializeTinyMCE_ =
			function() {
	 ...
	 */
	$.sep.controllers.form.FormHandler.prototype.submitHandler_ =
		...
		$(formElement).find('.sep_helpers_progressIndicator').show();
	 ...
	 * @private
	 */
	$.sep.controllers.form.FormHandler.prototype.pushTinyMCEChanges_ =
			function() {
		// ensure that rich content elements have their
		// values stored before validation.
		if (typeof tinyMCE !== 'undefined') {
	 ...
	 * @return {boolean} true.
	 */
	$.sep.controllers.form.FormHandler.prototype.setupEnableDisablePairs =
			function() {
		var formElement, key;
	 ...
	 * @private
	 */
	$.sep.controllers.form.FormHandler.prototype.toggleDependentElement_ =
