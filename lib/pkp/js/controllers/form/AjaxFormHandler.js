...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.form.FormHandler
	 *
	 * @param {jQueryObject} $form the wrapped HTML form element.
	 * @param {Object} options options to configure the AJAX form handler.
	 */
	$.sep.controllers.form.AjaxFormHandler = function($form, options) {
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.AjaxFormHandler.prototype.submitForm =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.AjaxFormHandler.prototype.refreshFormHandler_ =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.controllers.form.AjaxFormHandler.prototype.handleResponse =
		...
		$(this.getHtmlElement()).find('.sep_helpers_progressIndicator').hide();
