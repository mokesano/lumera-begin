...
(function($) {
	 ...
	 */
	$.sep.controllers.form.MultilingualInputHandler = function($popover, options) {
		// Bind to the focus of the primary language (the first input)
		// open the pop-over

		var $popoverNode = null;

		if ($popover.hasClass('sepTagit')) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.form.MultilingualInputHandler,
			$.sep.classes.Handler);
	 ...
	 * @type {Object}
	 */
	$.sep.controllers.form.MultilingualInputHandler.prototype.
	...
	//
	/**
	 * External hook for the 'sepmultilingualpopover' plugin for TinyMCE.
	 *
	 ...
	 */
	$.sep.controllers.form.MultilingualInputHandler.prototype.receiveEditorEvent =
	 ...
	 */
	$.sep.controllers.form.MultilingualInputHandler.prototype.multilingualShow =
	 ...
	 * @param {Event} event The event that triggered the action.
	 */
	$.sep.controllers.form.MultilingualInputHandler.prototype.multilingualHide =
			function(multilingualInput, event) {
