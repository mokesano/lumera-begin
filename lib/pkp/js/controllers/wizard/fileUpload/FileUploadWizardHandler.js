...
jQuery.sep.controllers.wizard.fileUpload =
			jQuery.sep.controllers.wizard.fileUpload || { };
...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.wizard.WizardHandler
	 *
	 * @param {jQuery} $wizard The wrapped HTML form element.
	 * @param {Object} options Wizard options.
	 */
	$.sep.controllers.wizard.fileUpload.FileUploadWizardHandler =
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.wizard.fileUpload.FileUploadWizardHandler,
			$.sep.controllers.wizard.WizardHandler);
	...
	$.sep.controllers.wizard.fileUpload.FileUploadWizardHandler.
		...
		if (this.uploadedFile_) {
			$.post(this.deleteUrl_, this.uploadedFile_,
					$.sep.classes.Helper.curry(this.wizardCancelSuccess, this,
