...
jQuery.sep.controllers.wizard.fileUpload.form =
			jQuery.sep.controllers.wizard.fileUpload.form || { };
...
(function($) {
	 ...
	 */
	$.sep.controllers.wizard.fileUpload.form.FileUploadFormHandler =
	 ...
	 */
	$.sep.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.
	...
	$.sep.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.
		...
		$uploader.sepHandler('$.sep.controllers.UploaderHandler', options);
	};
