...
jQuery.sep.controllers.wizard = jQuery.sep.controllers.wizard || { };
...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.TabHandler
	 *
	 * @param {jQuery} $wizard A wrapped HTML element that
	 *  represents the wizard.
	 * @param {Object} options Wizard options.
	 */
	$.sep.controllers.wizard.WizardHandler = function($wizard, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.wizard.WizardHandler, $.sep.controllers.TabHandler);
	 ...
	 * @type {jQuery}
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.$continueButton_ = null;
	 ...
	 * @type {jQuery}
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.$progressIndicator_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.continueButtonText_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.finishButtonText_ = null;
	 ...
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.continueRequest =
	 ...
	 * @param {Event} event The triggered event.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.formValid =
	 ...
	 * @param {Event} event The triggered event.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.formInvalid =
			function(formElement, event) {
	 ...
	 * @param {Event} event The triggered event.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.formSubmitted =
			function(formElement, event) {
	 ...
	 * @return {boolean} Should return false to stop event propagation.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.cancelRequest =
			function(buttonElement, event) {
	 ...
	 * returns true.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.wizardCancelRequested =
	 ...
	 * @param {Event} event The triggered event.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.wizardAdvanceRequested =
			function(wizardElement, event) {
	 ...
	 * @param {Event} event The triggered event.
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.wizardAdvance =
			function(wizardElement, event) {
	 ...
	 * @protected
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.startWizard = function() {
	 ...
	 * @protected
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.bindWizardEvents = function() {
	 ...
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.
	 ...
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.getForm_ = function() {
	 ...
	 * @private
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.advanceOrClose_ =
			function() {
		var currentStep = this.getCurrentStep(),
				lastStep = this.getNumberOfSteps() - 1;
	 ...
	 * @private
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.checkForm_ =
			function(prompt) {
		var $form = this.getForm_();
		var handler = $.sep.classes.Handler.getHandler($('#' + $form.attr('id')));
		if (prompt) {
			if (handler.formChangesTracked) {
				if (!confirm($.sep.locale.form_dataHasChanged)) {
	 ...
	 */
	$.sep.controllers.wizard.WizardHandler.prototype.addWizardButtons_ =
		...
		if (options.continueButtonText) {
			...
			var $continueButton = $(['<button id="continueButton"',
				'class="button sep_helpers_align_right">', options.continueButtonText,
				'</button>'].join('')).button();
			$wizardButtons.append($continueButton);

			var $progressIndicator = $(
					'<div class="sep_helpers_progressIndicator"></div>');
