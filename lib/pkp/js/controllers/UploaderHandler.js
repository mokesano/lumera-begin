 ...
 *
 * @brief SEP file uploader widget handler.
 */
(function($) {
	 ...
	 */
	$.sep.controllers.UploaderHandler = function($uploader, options) {
		...
		var uploaderOptions = $.extend(
				...
				// Non-default settings.
				{
					...
					flash_swf_url: options.baseUrl +
							'/lib/sep/js/lib/plupload/plupload.flash.swf',
					// Silverlight settings
					silverlight_xap_url: options.baseUrl +
							'/lib/sep/js/lib/plupload/plupload.silverlight.xap'
				});
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.UploaderHandler, $.sep.classes.Handler);
	 ...
	 *
	 */
	$.sep.controllers.UploaderHandler.prototype.
	 ...
	 * @const
	 */
	$.sep.controllers.UploaderHandler.DEFAULT_PROPERTIES_ = {
		// General settings
