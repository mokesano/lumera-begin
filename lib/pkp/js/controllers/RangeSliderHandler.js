 ...
 *
 * @brief SEP range slider handler (extends the functionality of the jqueryUI
 *  range slider)
 */
(function($) {
	 ...
	 */
	$.sep.controllers.RangeSliderHandler = function($rangeSliderField, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.controllers.RangeSliderHandler, $.sep.classes.Handler);
	 ...
	 * @type {HTMLElement}
	 */
	$.sep.controllers.RangeSliderHandler.slider_ = null;
	 ...
	 * @type {HTMLElement}
	 */
	$.sep.controllers.RangeSliderHandler.label_ = null;
	 ...
	 * @const
	 */
	$.sep.controllers.RangeSliderHandler.DEFAULT_PROPERTIES_ = {
		// General settings
		range: true
	};
	 ...
	 */
	$.sep.controllers.RangeSliderHandler.prototype.sliderAdjusted =
		...
		var $minVal = $(rangeSliderElement).children(
				'.sep_controllers_rangeSlider_minInput'
				);
		$minVal.val(ui.values[0]);
		var $maxVal = $(rangeSliderElement).children(
				'.sep_controllers_rangeSlider_maxInput'
				);
