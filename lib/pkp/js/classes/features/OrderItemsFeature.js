...
(function($) {
	 ...
	 * @type {array}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.itemsOrder_ = null;
	 ...
	 * @type {boolean}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.isOrdering_ = false;
	 ...
	 * @type {jQuery}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.$orderButton_ = null;
	 ...
	 * @type {jQuery}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.$cancelButton_ = null;
	 ...
	 * @type {jQuery}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.$saveButton_ = null;
	 ...
	 * @type {jQuery}
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.$finishControl_ = null;
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getOrderButton =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getFinishControl =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getSaveOrderButton =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getCancelOrderButton =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getMoveItemClasses =
			function() {
		return 'sep_helpers_moveicon ordering';
	};
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.dragStartCallback =
	 ...
	 * @param {Object} ui Object with data related to the event elements.
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.dragStopCallback =
			function(contextElement, event, ui) {
		// The default implementation does nothing.
	};
	 ...
	 * @param {Object} ui Object with data related to the event elements.
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.updateOrderCallback =
			function(contextElement, event, ui) {
		// The default implementation does nothing.
	};
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.init =
			function() {
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.addFeatureHtml =
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.addOrderingClassToRows =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.setupSortablePlugin =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.storeRowOrder =
			function(index, $row) {
		// The default implementation does nothing.
	};
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.clickOrderHandler =
			function() {
	 ...
	 * Save order handler.
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.saveOrderHandler =
			function() {
	 ...
	 * @return {boolean} Always returns false.
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.cancelOrderHandler =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleState =
			function(isOrdering) {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.storeOrder =
			function($rows) {
		this.itemsOrder_ = [];
		var index, limit;
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleItemsDragMode =
			function() {
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.applySortPlgOnElements =
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.getRowsDataId =
	 ...
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleMoveItemRowAction =
			function(enable) {
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.appendElement =
			function($element) {
		this.addOrderingClassToRows();
		this.toggleItemsDragMode();
	};
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.replaceElement =
			function($content) {
		this.addOrderingClassToRows();
		this.toggleItemsDragMode();
	};
	 ...
	 * @private
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleGridLinkActions_ =
			function() {
		var isOrdering = this.isOrdering_;

		// We want to enable/disable all link actions, except this
		// features controls.
		var $gridLinkActions = $('.sep_controllers_linkAction',
	 ...
	 * @private
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleOrderLink_ =
			function() {
		if (this.isOrdering_) {
	 ...
	 * @private
	 */
	$.sep.classes.features.OrderItemsFeature.prototype.toggleFinishControl_ =
			function() {
		if (this.isOrdering_) {
