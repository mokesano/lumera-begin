...
(function($) {
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderCategoryGridItemsFeature =
			function(gridHandler, options) {
		this.parent(gridHandler, options);
	};
	$.sep.classes.Helper.inherits(
			$.sep.classes.features.OrderCategoryGridItemsFeature,
			$.sep.classes.features.OrderGridItemsFeature);
	 ...
	 */
	$.sep.classes.features.OrderCategoryGridItemsFeature.prototype.
	...
	$.sep.classes.features.OrderCategoryGridItemsFeature.prototype.
		...
		if (type == $.sep.cons.ORDER_CATEGORY_GRID_CATEGORIES_ONLY ||
				type == $.sep.cons.ORDER_CATEGORY_GRID_CATEGORIES_AND_ROWS) {
			var $categories = this.gridHandler_.getCategories();
			$categories.addClass('orderable');
		}

		if (type == $.sep.cons.ORDER_CATEGORY_GRID_CATEGORIES_ROWS_ONLY ||
				type == $.sep.cons.ORDER_CATEGORY_GRID_CATEGORIES_AND_ROWS) {
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.features.OrderCategoryGridItemsFeature.prototype.getItemsDataId =
			function() {
