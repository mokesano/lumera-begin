 ...
 *
 * @brief SEP helper methods
 */
(function($) {

	// Create SEP namespaces.
	/** @type {Object} */
	$.sep = $.sep || { };


	/** @type {Object} */
	$.sep.classes = $.sep.classes || { };


	/** @type {Object} */
	$.sep.controllers = $.sep.controllers || { };


	/** @type {Object} */
	$.sep.controllers.form = $.sep.controllers.form || {};
	...
	/** @type {Object} */
	$.sep.plugins.blocks = $.sep.plugins.blocks || {};


	/** @type {Object} */
	$.sep.plugins.generic = $.sep.plugins.generic || {};
	 ...
	 * @type {Array}
	 */
	$.sep.classes.Helper.CHARS_ = ['0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ',
	 ...
	 * http://www.broofa.com, adapted by SEP.
	 *
	 ...
	 */
	$.sep.classes.Helper.uuid = function() {
		var chars = $.sep.classes.Helper.CHARS_, uuid = new Array(36), rnd = 0, r, i;
		for (i = 0; i < 36; i++) {
	 ...
	 *
	 * Example:
	 *  $.sep.classes.Parent = function() {...};
	 *  $.sep.classes.Child = function() {...};
	 *  $.sep.classes.Helper.inherits($.sep.classes.Child, $.sep.classes.Parent);
	 *
	 * @param {Function} Child Constructor of the child object.
	 * @param {Function} Parent Constructor of the parent object.
	 */
	$.sep.classes.Helper.inherits = function(Child, Parent) {
	 ...
	 * @return {$.sep.classes.ObjectProxy} the instantiated object.
	 */
	$.sep.classes.Helper.objectFactory = function(objectName, args) {
		var ObjectConstructor, ObjectProxyInstance, objectInstance;

		// Resolve the object name.
		ObjectConstructor = $.sep.classes.Helper.resolveObjectName(objectName);

		// Create a new proxy constructor instance.
		ObjectProxyInstance = $.sep.classes.Helper.getObjectProxyInstance();
		...
		$.extend(true, ObjectProxyInstance, $.sep.classes.ObjectProxy);

		// Let the proxy inherit from the proxied object.
		$.sep.classes.Helper.inherits(ObjectProxyInstance, ObjectConstructor);

		// Enrich the new proxy constructor prototype with proxy object
		// prototype members.
		$.extend(true, ObjectProxyInstance.prototype,
				$.sep.classes.ObjectProxy.prototype);
	 ...
	 */
	$.sep.classes.Helper.resolveObjectName = function(objectName) {
	 ...
	 */
	$.sep.classes.Helper.getObjectProxyInstance = function() {
	 ...
	 *  object factory.
	 */
	$.sep.classes.Helper.injectMixin = function(Constructor, mixinObjectName) {
		// Retrieve an instance of the mix-in interface implementation.
		var mixin = $.sep.classes.Helper.objectFactory(mixinObjectName, []);
	 ...
	 */
	$.sep.classes.Helper.curry = function(fn, context) {
