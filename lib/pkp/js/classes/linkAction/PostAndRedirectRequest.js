...
(function($) {
	 ...
	 *  request.
	 */
	$.sep.classes.linkAction.PostAndRedirectRequest =
	 ...
	 * @inheritDoc
	 */
	$.sep.classes.linkAction.PostAndRedirectRequest.prototype.activate =
		...
		var finishCallback = $.sep.classes.Helper.curry(
	 ...
	 * @private
	 */
	$.sep.classes.linkAction.PostAndRedirectRequest.prototype.finishCallback_ =
			function() {
		this.finish();
	};
	 ...
	 * @private
	 */
	$.sep.classes.linkAction.PostAndRedirectRequest.prototype.handleResponse_ =
			function(jsonData) {
		var options = this.getOptions();
