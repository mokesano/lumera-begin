...
(function($) {
	 ...
	 * @type {Array}
	 */
	$.sep.classes.Handler.prototype.publishChangeEvents_ = null;
	 ...
	 * @type {jQueryObject}
	 */
	$.sep.classes.Handler.prototype.$htmlElement_ = null;
	 ...
	 */
	$.sep.classes.Handler.prototype.eventBindings_ = null;
	 ...
	 */
	$.sep.classes.Handler.prototype.dataItems_ = null;
	 ...
	 * @type {Object.<string, boolean>}
	 */
	$.sep.classes.Handler.prototype.publishedEvents_ = null;
	 ...
	 * @type {?string}
	 */
	$.sep.classes.Handler.prototype.$eventBridge_ = null;
	 ...
	 */
	$.sep.classes.Handler.getHandler = function($element) {
		...
		// directly.
		var handler = $element.data('sep.handler');

		// Check whether the handler exists.
		if (!(handler instanceof $.sep.classes.Handler)) {
	 ...
	 */
	$.sep.classes.Handler.prototype.getHtmlElement = function() {
		$.sep.classes.Handler.checkContext_(this);
	 ...
	 */
	$.sep.classes.Handler.prototype.publishChangeEvents = function() {
		var i;
		for (i = 0; i < this.publishChangeEvents_.length; i++) {
	 ...
	 *  to jQuery.
	 */
	$.sep.classes.Handler.prototype.handleEvent = function(event) {
		...
		handler = $.sep.classes.Handler.getHandler($callingElement);
	 ...
	 */
	$.sep.classes.Handler.prototype.callbackWrapper =
	 ...
	 */
	/*jslint unparam: true*/
	$.sep.classes.Handler.prototype.remoteResponse =
	 ...
	 */
	$.sep.classes.Handler.prototype.remove = function() {
		$.sep.classes.Handler.checkContext_(this);
		var $element, key;

		// Remove all event handlers in our namespace.
		$element = this.getHtmlElement();
		$element.unbind('.sepHandler');
		...
		$element.trigger('sepRemoveHandler');
		$element.unbind('.sepHandlerRemove');

		// Delete the handler.
		$element.removeData('sep.handler');
	};
	 ...
	 */
	$.sep.classes.Handler.prototype.bind = function(eventName, handler) {
		$.sep.classes.Handler.checkContext_(this);
		...
		if (!this.eventBindings_[eventName]) {
			...
			var eventNamespace;
			eventNamespace = '.sepHandler';
			if (eventName === 'sepRemoveHandler') {
				...
				eventNamespace = '.sepHandlerRemove';
			}
	 ...
	 */
	$.sep.classes.Handler.prototype.unbind = function(eventName, handler) {
		$.sep.classes.Handler.checkContext_(this);
	 ...
	 */
	$.sep.classes.Handler.prototype.data = function(key, opt_value) {
		$.sep.classes.Handler.checkContext_(this);
	 ...
	 */
	$.sep.classes.Handler.prototype.handleJson = function(jsonData) {
		if (!jsonData) {
	 ...
	 */
	$.sep.classes.Handler.prototype.trigger =
	 ...
	 */
	$.sep.classes.Handler.prototype.publishEvent = function(eventName) {
	 ...
	 */
	$.sep.classes.Handler.prototype.switchViz = function(event) {
	 ...
	 * @param {Array=} opt_data Additional event data.
	 */
	$.sep.classes.Handler.prototype.triggerPublicEvent_ =
			function(eventName, opt_data) {
	 ...
	 *  to be tested.
	 */
	$.sep.classes.Handler.checkContext_ = function(context) {
		if (!(context instanceof $.sep.classes.Handler)) {
