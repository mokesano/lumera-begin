...
<div id="focusAndScope" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.focusAndScope"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="sectionPolicies" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.sectionPolicies"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
{if $currentJournal->getLocalizedSetting('reviewPolicy') != ''}<div id="peerReviewProcess" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.peerReviewProcess"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="publicationFrequency" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.publicationFrequency"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="openAccessPolicy" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.openAccessPolicy"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="authorSelfArchivePolicy" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.authorSelfArchive"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header> 
...
<div id="delayedOpenAccessPolicy" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.delayedOpenAccess"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header> 
...
<div id="archiving" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.archiving"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
{foreach key=key from=$currentJournal->getLocalizedSetting('customAboutItems') item=customAboutItem name=customAboutItems}
	{if !empty($customAboutItem.title)}
		<div id="custom-{$key|escape}">
		    <header class="c-anchored-heading"><h3>{$customAboutItem.title|escape}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
		    </header>
