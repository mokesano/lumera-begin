...
<div id="ctx-publisher-footer">
    <div id="c-footer-navbar">
        <div id="c-footer-container">
            <div class="c-footer__logo u-margin-right-xl">
                <a href="https://scofci.stipwunaraha.ac.id"/><img src="{$baseUrl}/public/images/cocosire.svg" alt="COSIRE Indonesia Logo" width="auto" height="27px"></a> 
            </div>
        </div>
...
{call_hook name="Templates::Common::Footer::PageFooter"}
	<div id="standardFooter">
		    <img src="{$baseUrl}/public/site/images/cosire-foother.svg" width="auto" height="33px">
