		...
		{if $leftSidebarCode}
			<div id="leftSidebar" class="slide" role="complementary">
			    ...
			    <ul class="c-sidemenu c-bar--menu c-nav c-nav--stacked c-collapse-at-lt-md">
			        <li id="linkJournalHistory" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="history" anchor=""}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.history"}</span></a></li>
			        <li id="linkSponsorship" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="journalSponsorship" anchor=""}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.journalSponsorship"}</span></a></li>
			        <li id="linkSiteMap" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="siteMap" anchor=""}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.siteMap"}</span></a></li>
			        <li id="linkAboutPublishing" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="aboutThisPublishingSystem" anchor=""}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.aboutThisPublishingSystem"}</span></a></li>
			        </ul>
			</div>
		{/if}
		{if $rightSidebarCode}
