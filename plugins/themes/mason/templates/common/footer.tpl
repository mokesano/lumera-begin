...
<div id="c-journal-footer">
    <div id="c-journal-footer__inner">
		...
		<div id="c-journal-footer__contact">
		    <h6 class="c-journal-footer__contact-title">Contact us</h6>
...
<div id="ctx-publisher-footer">
    <div id="c-footer-navbar">
        <div id="c-footer-container">
            <div id="c-footer__logo u-margin-right-xl">
                <img src="{$baseUrl}/public/images/cocosire.svg" alt="COSIRE Indonesia Logo" width="auto" height="27px"> <a href="https://scofci.stipwunaraha.ac.id"/></a> 
            </div>
        </div>
        <div id="c-navbar__content">
            <ul id="c-navbar__nav" style="list-style:none;padding-left:0">
                <li class="c-navbar__item">
                    <a class="c-navbar__link" href="#">Explore journals</a>
                    </li>
                <li class="c-navbar__item">
                    <a class="c-navbar__link" href="#">Get published</a>
                    </li>
                <li class="c-navbar__item">
                    <a class="c-navbar__link" href="#">About COSIRE</a>
                    </li>
            </ul>
        </div>
    </div>
...
{call_hook name="Templates::Common::Footer::PageFooter"}
	<div id="standardFooter">
		...
		<p><b>© 2019</b> <a href="https://scofci.stipwunaraha.ac.id">Coastal and Isles Research</a> unless otherwise stated. <b>Part of</b> <a href="https://stipwunaraha.ac.id">Aquaculture Department, Wuna Agricultural Sciences University</a>.</p>
		</a>
	</div>
{/strip}
