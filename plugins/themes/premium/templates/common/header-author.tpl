	...
	<div id="sidebar">
		{if $leftSidebarCode}
			<div id="leftSidebar" class="slide" role="complementary">
			    ...
			    <ul class="c-sidemenu c-bar--menu c-nav c-nav--stacked c-collapse-at-lt-md">{if $currentJournal->getLocalizedSetting('focusScopeDesc') != ''}
			        ...
			        {if $peopleGroups}
			        <li id="linkReviewer" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="displayMembership" path=$peopleGroup->getId()}"><span class="c-flex c-flex--align-baseline">{$peopleGroup->getLocalizedTitle()|escape}</span></a></li>
			        {/if}
		...
		{if $rightSidebarCode}
			<div id="rightSidebar" class="slide" role="complementary">
				...
				<a href="https://plu.mx/u/rochmady" class="plumx-person"></a><script type="text/javascript" src="//cdn.plu.mx/widget-person.js"></script>
				{$rightSidebarCode}
			</div>
		{/if}
	</div>
...
<div id="main" class="main-author" role="main" tabindex="-1">
