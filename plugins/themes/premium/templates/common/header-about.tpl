		...
		{if $leftSidebarCode}
			<div id="leftSidebar" class="slide" role="complementary">
			    ...
			    <ul class="c-sidemenu c-bar--menu c-nav c-nav--stacked c-collapse-at-lt-md">
			        <li id="linkEditorialPolicies" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="" anchor="aboutPeople"}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.people"}</span></a></li>
			        <li id="linkReviewPolicy" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="" anchor="aboutPolicies"}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.policies"}</span></a></li>
			        <li id="linkPubFreqPolicy" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="" anchor="aboutSubmissions"}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.submissions"}</span></a></li>
			        <li id="linkaboutOther" class="c-sidemenu c-bar--menu"><a href="{url page="about" op="" anchor="aboutOther"}">
			            <span class="c-flex c-flex--align-baseline">{translate key="about.other"}</span></a></li>
			        </ul>
			</div>
		{/if}
		{if $rightSidebarCode}
