		...
		{if $leftSidebarCode}
			<div id="leftSidebar" class="slide" role="complementary">
			    ...
			    <ul class="c-sidemenu c-bar--menu c-nav c-nav--stacked c-collapse-at-lt-md">
			        {if !$currentJournal->getSetting('disableUserReg')}<li id="linkDisableUserReg"><a href="{url page="about" op="submissions" anchor="onlineSubmissions"}"><span class="c-flex c-flex--align-baseline">{translate key="about.onlineSubmissions"}</span></a></li>{/if}
			        {if $currentJournal->getLocalizedSetting('authorGuidelines') != ''}<li id="linkAuthorGuidelines"><a href="{url page="about" op="submissions" anchor="authorGuidelines"}"><span class="c-flex c-flex--align-baseline">{translate key="about.authorGuidelines"}</span></a></li>{/if}
			        {if $currentJournal->getLocalizedSetting('copyrightNotice') != ''}<li id="linkCopyrightNotice"><a href="{url page="about" op="submissions" anchor="copyrightNotice"}"><span class="c-flex c-flex--align-baseline">{translate key="about.copyrightNotice"}</span></a></li>{/if}
			        {if $currentJournal->getLocalizedSetting('privacyStatement') != ''}<li id="linkPrivacyStatement"><a href="{url page="about" op="submissions" anchor="privacyStatement"}"><span class="c-flex c-flex--align-baseline">{translate key="about.privacyStatement"}</span></a></li>{/if}
			        {if $authorFees}<li id="linkAuthorFees"><a href="{url page="about" op="submissions" anchor="authorFees"}"><span class="c-flex c-flex--align-baseline">{translate key="about.authorFees"}</span></a></li>{/if}
			        </ul>
			</div>
		{/if}
		{if $rightSidebarCode}
