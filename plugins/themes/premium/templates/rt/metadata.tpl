...
<table class="listing" width="100%">
	...
	<tr valign="top">
		...
		<td class="heading" width="25%">{translate key="rt.metadata.sepItem"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.title"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.primaryAuthor"}</td>
	<td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.discipline"}</td>
...
<tr valign="top">
	<td>3.</td>
	<td>{translate key="rt.metadata.dublinCore.subject"}</td>
	<td>{translate key="rt.metadata.sep.subject"}</td>
...
<tr valign="top">
	<td>3.</td>
	<td>{translate key="rt.metadata.dublinCore.subject"}</td>
	<td>{translate key="rt.metadata.sep.subjectClass"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.abstract"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.publisher"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.sponsors"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.date"}</td>
	<td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.genre"}</td>
	<td>{if $section && $section->getLocalizedIdentifyType()}{$section->getLocalizedIdentifyType()|escape}{else}{translate key="rt.metadata.sep.peerReviewed"}{/if}</td>
</tr>
<tr><td colspan="4" class="separator">&nbsp;</td></tr>
<tr valign="top">
	<td>8.</td>
	<td>{translate key="rt.metadata.dublinCore.type"}</td>
	<td>{translate key="rt.metadata.sep.type"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.format"}</td>
	<td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.uri"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.source"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.language"}</td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.suppFiles"}</td>
	<td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.coverage"}</td>
	<td>
...
<tr valign="top">
	...
	<td>{translate key="rt.metadata.sep.copyright"}</td>
	<td>
