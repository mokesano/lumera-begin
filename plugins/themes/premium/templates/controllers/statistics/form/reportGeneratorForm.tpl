...
<script type="text/javascript">
	$(function() {ldelim}
		...
		$('#reportGeneratorForm').sepHandler('$.sep.statistics.ReportGeneratorFormHandler',
			{ldelim}
...
<form class="sep_form" id="reportGeneratorForm" method="post" action="{url op="saveReportGenerator"}">
