            ...
            <td class="tocArticleTitleAuthors Info">
                <div class="article-list">
                    ...
                    <div class="tocAuthors">
                        ...
                        {/foreach}
                        in <a title="Go to {$journal->getLocalizedTitle()|escape}" target="_blank" href="{url journal=$journal->getPath()}"><em>{$currentJournal->getLocalizedTitle()|strip_tags|escape}</a> ({$issue->getDatePublished()|date_format:'%B %Y'})</em>
                    </div>
