...
(function($) {
	 ...
	 * @constructor
	 *
	 * @extends $.sep.controllers.form.AjaxFormHandler
	 *\
	 ...
	 */
	$.sep.statistics.ReportGeneratorFormHandler = function($form, options) {
	...
	$.sep.classes.Helper.inherits(
			$.sep.statistics.ReportGeneratorFormHandler,
			$.sep.controllers.form.AjaxFormHandler);
	 ...
	 * @type {?string}
	 */
	$.sep.statistics.ReportGeneratorFormHandler.prototype.
			fetchFormUrl_ = null;
	 ...
	 * @inheritDoc
	 */
	$.sep.statistics.ReportGeneratorFormHandler.prototype.handleResponse =
	 ...
	 */
	$.sep.statistics.ReportGeneratorFormHandler.prototype.fetchFormHandler_ =
			function() {
	 ...
	 * @return {boolean} Should return false to stop event processing.
	 */
	$.sep.statistics.ReportGeneratorFormHandler.prototype.fetchArticleInfoHandler_ =
	 ...
	 * @return {boolean} Should return false to stop event processing.
	 */
	$.sep.statistics.ReportGeneratorFormHandler.prototype.fetchRegionHandler_ =
			function(callingContext) {
