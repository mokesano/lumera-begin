...
{foreach from=$journals item=journal}
	...
	{else}
		<div class="homepageImage"><a href="{url journal=$journal->getPath()}" class="action"><img class="cover lazy" src="//media.stipwunaraha.ac.id/img/img-default.jpg" alt="Stipwunaraha Media & Publishing Group" /></a></div>
	{/if}
	</div>
