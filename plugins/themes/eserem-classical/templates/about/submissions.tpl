...
<div id="onlineSubmissions" class="submit--value">
	<h3 class="sub_title">{translate key="about.onlineSubmissions"}</h3>
	<p>
		{translate key="about.onlineSubmissions.haveAccount" journalTitle=$siteTitle|escape}<br />
		<a href="{url page="login"}" class="all btn btn-primary btn-monster success">{translate key="about.onlineSubmissions.login"}</a>
	</p>
	{if !$currentJournal->getSetting('disableUserReg')}
		<p>
			{translate key="about.onlineSubmissions.needAccount"}<br />
			<a href="{url page="user" op="register"}" class="all btn btn-primary btn-monster info">{translate key="about.onlineSubmissions.registration"}</a>
		</p>
...
<div id="authorGuidelines">
	<h3 class="sub_title">{translate key="about.authorGuidelines"}</h3>
...
{if $submissionChecklist}
	<div id="submissionPreparationChecklist">
		<h3 class="sub_title">{translate key="about.submissionPreparationChecklist"}</h3>
...
<div id="copyrightNotice">
	<h3 class="sub_title">{translate key="about.copyrightNotice"}</h3>
...
<div id="privacyStatement">
	<h3 class="sub_title">{translate key="about.privacyStatement"}</h3>
...
{if $authorFees}
<div id="authorFees">
	<h3 class="sub_title">{translate key="manager.payment.authorFees"}</h3>
