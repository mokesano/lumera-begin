...
<h2 class="sub_title">{translate key="common.mailingAddress"}</h2>
<br />
...
<h2 class="sub_title">{translate key="about.contact.principalContact"}</h2>
<p>
	{if !empty($journalSettings.contactName)}
		<h4><strong>{$journalSettings.contactName|escape}</strong></h4>
	{/if}
...
<h2 class="sub_title">{translate key="about.contact.supportContact"}</h2>
<p>
	{if !empty($journalSettings.supportName)}
		<h4><strong>{$journalSettings.supportName|escape}</strong></h4>
	{/if}
