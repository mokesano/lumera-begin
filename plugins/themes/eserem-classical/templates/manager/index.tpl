...
<h3 class="sub-titles">{translate key="manager.managementPages"}</h3>
...
<div id="managerUsers">
<h3 class="sub_title">{translate key="manager.users"}</h3>
...
<div id="managerRoles">
<h3 class="sub_title">{translate key="manager.roles"}</h3>
