...
<h4>Associated and/or Sponsored</h4>
...
<br />
<img src="{$publicFilesDir}/{$journalThumbnail[$formLocale].uploadName|escape:"url"}" width="{$journalThumbnail[$formLocale].width|escape}" height="{$journalThumbnail[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.journalThumbnail.altText"}" />
<br />
<table width="100%" class="data">
	<tr valign="top">
...
<br />
<img src="{$publicFilesDir}/{$homepageImage[$formLocale].uploadName|escape:"url"}" width="{$homepageImage[$formLocale].width|escape}" height="{$homepageImage[$formLocale].height|escape}" style="border: 0; width: 100%; height: auto;" alt="{translate key="common.journalHomepageImage.altText"}" />
<br />
<table width="100%" class="data">
	<tr valign="top">
...
<h3>5.5 Additional Links</h3>

<p>Additional links items can be added to the current set in homepage that appear at the left and right side of the page.</p>
