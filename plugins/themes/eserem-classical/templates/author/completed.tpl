...
<table class="listing" width="100%">
	...
	<tr valign="bottom" class="functions-bar functions-bar-top heading">
		...
		<td width="25%" align="center">{sort_heading key="common.status" sort="status"}</td>
	</tr>
	<tr><td class="headseparator" colspan="{if $statViews}7{else}6{/if}">&nbsp;</td></tr>
{iterate from=submissions item=submission}
	...
	<tr valign="top">
		...
		<td><a href="{url op="submission" path=$articleId}" class="action">{$submission->getLocalizedTitle()|strip_unsafe_html|truncate:70:"..."}</a></td>
