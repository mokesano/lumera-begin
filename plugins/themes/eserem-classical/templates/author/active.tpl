...
{iterate from=submissions item=submission}
	...
	<tr valign="top">
		...
		{if $progress == 0}
			<td><a href="{url op="submission" path=$articleId}" class="action">{if $submission->getLocalizedTitle()}{$submission->getLocalizedTitle()|strip_unsafe_html}{else}{translate key="common.untitled"}{/if}</a></td>
			<td align="right">
		...
		{else}
			<td><a href="{url op="submit" path=$progress articleId=$articleId}" class="action">{if $submission->getLocalizedTitle()}{$submission->getLocalizedTitle()|strip_unsafe_html}{else}{translate key="common.untitled"}{/if}</a></td>
