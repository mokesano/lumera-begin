...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		...
		<td width="45%">{sort_search key="article.title" sort="title"}</td>
	...
	<tr valign="top" {if $submission->getFastTracked()} class="fastTracked"{/if}>
		...
		<td><a href="{url op="submissionEditing" path=$articleId}" class="action">{$submission->getLocalizedTitle()|strip_unsafe_html}</a></td>
		<td align="right">
