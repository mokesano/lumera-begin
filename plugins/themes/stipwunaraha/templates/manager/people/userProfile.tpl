...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="label">{translate key="user.scopus"}</td>
		<td class="value">{$user->getScopus|escape|default:"&mdash;"}</td>
	</tr>
	<tr valign="top">
		<td class="label">{translate key="user.sinta"}</td>
		<td class="value">{$user->getSinta|escape|default:"&mdash;"}</td>
	</tr>	
	<tr valign="top">
