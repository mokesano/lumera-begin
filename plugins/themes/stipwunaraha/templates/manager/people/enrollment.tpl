...
<table width="100%" class="listing">
	...
	<tr class="heading" valign="bottom">
		<td width="5%">&nbsp;</td>
		<td width="17%">{sort_heading key="user.username" sort="username"}</td>
