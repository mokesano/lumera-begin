...
{include file="common/navbar.tpl"}
    ...
    <div id="c-navbarSearch" role="navigation">
        <form id="simpleSearchForm" method="post" action="{url page="search" op="search"}" style="float: left;align-content: start;padding-bottom: 0;display: flex;">
            <input type="text" name="q" id="search" placeholder="Search article within this journal" class="journal-search uk-width-large-8-10 input-search">
            <button type="submit" class="uk-button uk-button-primary btn-search">
            <i class="uk-icon-search"></i></button>
        </form>
        <div class="navbarlargeButton _largeButton"> <a href="{url page="about" op="submissions" anchor="onlineSubmissions"}">{translate key="user.noRoles.submitArticle"}</a>
        </div>
    </div>
...
{if $leftSidebarCode || $rightSidebarCode}
	<div id="sidebar">
		{if $rightSidebarCode}
			<div id="rightSidebar" class="slide-left slide-right" role="complementary">
			    {if $homepageImage}
...
<div id="c-main" class="main-contents" role="main">
