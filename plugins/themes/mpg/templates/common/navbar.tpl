...
<div id="fullNav" class="c-navbar">
    ...
    <div id="navbar" role="navigation" style="width: 100%;">
	    <ul class="navMenu menu" style="float: left;">
		    {if $siteCategoriesEnabled}
			<li id="categories"><a href="/">{translate key="navigation.otherJournals"}</a></li>
        ...
        <ul class="navMenu menu" style="float: right;">
            {if $isUserLoggedIn}
            {if $hasOtherJournals}
