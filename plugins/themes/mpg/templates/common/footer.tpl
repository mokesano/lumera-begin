...
<div id="c-journal-footer">
    <div id="c-journal-footer__inner">
        <div id="c-journal-footer__summary">
            <div id="c-journal-footer-logo">
                <figure>{if $displayPageHeaderLogo && is_array($displayPageHeaderLogo)}<img src="{$publicFilesDir}/{$displayPageHeaderLogo.uploadName|escape:"url"}" width="{$displayPageHeaderLogo.width|escape}" height="{$displayPageHeaderLogo.height|escape}" {if $displayPageHeaderLogoAltText != ''}alt="{$displayPageHeaderLogoAltText|escape}"{else}alt="{translate key="common.pageHeaderLogo.altText"}"{/if} />
                </figure>{/if}
            <h4 class="c-journal-footer__title-text">{if $displayPageHeaderTitle && is_array($displayPageHeaderTitle)}
            {elseif $displayPageHeaderTitle}{$displayPageHeaderTitle}
            {elseif $alternatePageHeader}{$alternatePageHeader}
            {elseif $siteTitle}{$siteTitle}
            {else} {$applicationName}{/if}</h4>
            {if $issn}
                ...
                <div class="c-flex" aria-label="Publisher footer links">
                    <ul class="c-list-group c-list-group--sm u-margin-right-lg u-margin-bottom-md">
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="https://scofci.stipwunaraha.ac.id/">Read more on blogs</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Indexing">Abtracting & Indexing</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Editorial%20Process">Editorial Process</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Author%28s%29%20Fees">Author(s) Fees</a>
                            </li>
                    </ul>
                    <ul class="c-list-group c-list-group--sm u-margin-right-lg u-margin-bottom-md">
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Guide%20for%20Registration">Registration Guide</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Publication%20Ethics">Publication Ethics</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/about/editorialPolicies#custom-0">Plagiarisme Check</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Authorship%20Guidelines">Authorship Guidelines</a>
                            </li>
                    </ul>
                    <ul class="c-list-group c-list-group--sm u-margin-right-lg u-margin-bottom-md">
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/Contact">Contact us</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="https://scholar.google.co.id/citations?user=sxSxyCQAAAAJ&hl=id&authuser=6">Google Scholar</a>
                            </li>
                        <li class="c-list-group__item">
                            <a class="u-text-inherit margin" href="/index.php/ISLE/pages/view/faq">FAQ</a>
                            </li>    
                    </ul>
                </div>
            </div>
                ...
                <ul class="c-flex u-reset-list" data-test="footer-social-links" style="list-style:none;padding-left:0">
                    <li class="u-margin-top-xs u-margin-right-xs">
                        <a href="https://twitter.com/SRMKen" class="u-text-inherit" data-track="click" data-track-action="Click Twitter link" data-track-category="Publisher footer" target="_blank">
                            ...
                            <svg class="c-icon" width="24" height="24" ><use xlink:href="#icon-twitter-bordered"><symbol id="icon-twitter-bordered" viewBox="463.812 263.868 32 32"><path d="M486.416 276.191a5.622 5.622 0 0 1-1.554.429 2.718 2.718 0 0 0 1.19-1.502 5.456 5.456 0 0 1-1.72.657 2.71 2.71 0 0 0-1.979-.854 2.711 2.711 0 0 0-2.642 3.326 7.681 7.681 0 0 1-5.586-2.831 2.714 2.714 0 0 0 .839 3.618 2.748 2.748 0 0 1-1.227-.339v.031a2.71 2.71 0 0 0 2.174 2.656 2.735 2.735 0 0 1-1.229.049 2.726 2.726 0 0 0 2.531 1.883 5.442 5.442 0 0 1-4.01 1.123 7.672 7.672 0 0 0 4.155 1.215c4.983 0 7.71-4.129 7.71-7.711 0-.115-.004-.232-.006-.351a5.41 5.41 0 0 0 1.354-1.399z"></path><path d="M479.812 263.868c-8.837 0-16 7.163-16 16s7.163 16 16 16 16-7.163 16-16-7.163-16-16-16zm0 30c-7.732 0-14-6.269-14-14s6.268-14 14-14 14 6.269 14 14-6.267 14-14 14z"></path></symbol></use></svg></a>
                        </li>
                    <li class="u-margin-top-xs u-margin-right-xs">
...
{call_hook name="Templates::Common::Footer::PageFooter"}
	<div id="standardFooter">
		...
		<p><b>© 2019</b> <a href="https://scofci.stipwunaraha.ac.id">Coastal and Isles Research</a> unless otherwise stated. <b>Part of</b> <a href="https://stipwunaraha.ac.id">Stipwunaraha Research Media</a>.</p>
		</a>
	</div>
{/strip}
