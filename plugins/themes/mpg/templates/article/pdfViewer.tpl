...
<div id="pdfDownloadLinkContainer" class="u-font-sans">
	<a class="action pdf u-font-sans" id="pdfDownloadLink" target="_parent" href="{url op="download" path=$articleId|to_array:$galley->getBestGalleyId($currentJournal)}">{translate key="article.pdf.download"}</a>
</div>
...
<div id="inlinePdfResizer">
	<div id="inlinePdf" class="ui-widget-content u-font-sans">
		<div id='pluginMissing'>{translate key="article.pdf.pluginMissing"}</div>
	</div>
</div>
<p>
	<a class="action u-font-sans" href="#" id="fullscreenShow">{translate key="common.fullscreen"}</a>
	<a class="action u-font-sans" href="#" id="fullscreenHide">{translate key="common.fullscreenOff"}</a>
</p>
