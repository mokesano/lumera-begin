...
<table width="100%" class="listing">
	...
	<tr valign="top">
		...
		<td>{$file.mtime|escape|date_format:$datetimeFormatLong}</td>
...
<form id="form-manager" method="post" action="{url op="fileUpload" path=$currentDir|explode:"/"}" enctype="multipart/form-data">
...
<form class="form manager" method="post" action="{url op="fileMakeDir" path=$currentDir|explode:"/"}" enctype="multipart/form-data">
...
<p class="notes">{translate key="manager.files.note"}</p>
