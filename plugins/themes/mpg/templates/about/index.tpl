...
{/strip}
<div id="aboutPeople" class="block adonMenu">
    <header class="c-anchored-heading"><h3>{translate key="about.people"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
<ul>
...
<div id="aboutPolicies" class="block adonMenu">
    <header class="c-anchored-heading"><h3>{translate key="about.policies"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
<ul>
...
<div id="aboutSubmissions" class="block adonMenu">
    <header class="c-anchored-heading"><h3>{translate key="about.submissions"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
<ul>
...
<div id="aboutOther" class="block adonMenu">
    <header class="c-anchored-heading"><h3>{translate key="about.other"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
<ul>
