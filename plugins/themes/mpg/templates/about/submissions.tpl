...
{include file="common/header-submission.tpl"}
{/strip}
...
{if !$currentJournal->getSetting('disableUserReg')}
	<div id="onlineSubmissions" class="block">
		<header class="c-anchored-heading"><h3>{translate key="about.onlineSubmissions"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
		</header>
...
<div id="authorGuidelines" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.authorGuidelines"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
{if $submissionChecklist}
	<div id="submissionPreparationChecklist" class="block">
	    <header class="c-anchored-heading"><h3>{translate key="about.submissionPreparationChecklist"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="copyrightNotice" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.copyrightNotice"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
{if $currentJournal->getLocalizedSetting('privacyStatement') != ''}<div id="privacyStatement" class="block">
    <header class="c-anchored-heading"><h3>{translate key="about.privacyStatement"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
...
<div id="authorFees" class="block">
    <header class="c-anchored-heading"><h3>{translate key="manager.payment.authorFees"}</h3><a class="c-anchored-heading__helper" href="#navbarMenu">Back to top</a>
    </header>
