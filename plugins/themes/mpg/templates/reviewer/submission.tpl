...
<tr valign="top">
	...
	<td class="value" style="font-style: italic">{$submission->getSectionTitle()|escape}</td>
</tr>
<tr valign="top">
	<td width="20%" class="label">Manuscript {translate key="article.title"}</td>
	<td width="80%" class="value" style="font-weight: 700">{$submission->getLocalizedTitle()|strip_unsafe_html}</td>
</tr>
<tr valign="top">
