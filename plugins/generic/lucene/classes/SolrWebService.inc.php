...
class SolrWebService extends XmlWebService {
	...
	/** @var string The unique ID identifying this CLA installation to the solr server. */
	var $_instId;
	 ...
	 * @param $instId string The unique ID of this CLA installation to partition
	 *  a shared index.
	...
	function getServerStatus() {
		...
		$nodeList = $response->query('/response/lst[@name="status"]/lst[@name="cla"]/lst[@name="index"]/int[@name="numDocs"]');
	 ...
	 * could realistically arise with CLA.
	 *
	...
	function _setQuery($fieldList, $searchPhrase, $spellcheck = false) {
		...
		$params = array(
			...
			// This deviates from previous CLA practice, please see
			// http://lumera.sangia.org/wiki/index.php/CLAdeSearchConcept#Query_Parser
