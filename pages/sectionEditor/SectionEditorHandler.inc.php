...
class SectionEditorHandler extends Handler {
	...
	function setupTemplate($subclass = false, $articleId = 0, $parentPage = null, $showSidebar = true) {
		...
		AppLocale::requireComponents(LOCALE_COMPONENT_SEP_SUBMISSION, LOCALE_COMPONENT_CLA_EDITOR, LOCALE_COMPONENT_SEP_MANAGER, LOCALE_COMPONENT_CLA_AUTHOR, LOCALE_COMPONENT_CLA_MANAGER);
		$templateMgr =& TemplateManager::getManager();
